        ...
        <div className="max-w-7x1 mx-auto px-4 pt-20 pb-32 relative">
          <div className="max-w-5x1 mx-auto text-center space-y-6">
            <h1 className="text-5xl md:text-6xl font-bold leading-tight">I am Ayanokoji{''}
              <span className="text-[#4dff6b]"> Web Development</span>
              <br />
              So you dont have to{''}
              <span className="text-[#ff4d97]"> worry about?</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              ...
              <Button size="lg" variant="outline" className="border-gray-700">Learn To Explore</Button>
            </div>
          </div>
